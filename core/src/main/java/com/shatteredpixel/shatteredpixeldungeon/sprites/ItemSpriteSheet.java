...
public class ItemSpriteSheet {
	...
	static{
		...
		assignItemRect(SKELETON_KEY,    13,  16);
		assignItemRect(MASK,            11,  9);
		assignItemRect(CROWN,           11,  11);
	...
	static{
		assignItemRect(LONGSWORD,       15, 16);
		assignItemRect(BATTLE_AXE,      16, 16);
		assignItemRect(FLAIL,           14, 14);
		assignItemRect(RUNIC_BLADE,     14, 14);
		assignItemRect(ASSASSINS_BLADE, 16, 13);
	...
	static{
		assignItemRect(GREATSWORD,  14, 14);
		assignItemRect(WAR_HAMMER,  16, 16);
		assignItemRect(GLAIVE,      16, 16);
		assignItemRect(GREATAXE,    14, 14);
		assignItemRect(GREATSHIELD, 12, 16);
		assignItemRect(GAUNTLETS,   13, 15);
		assignItemRect(WAR_SCYTHE,  16, 15);
	}
	...
	static{
		...
		assignItemRect(ARMOR_MAGE,      13, 14);
		assignItemRect(ARMOR_ROGUE,     14, 10);
		assignItemRect(ARMOR_HUNTRESS,  10, 12);
		assignItemRect(ARMOR_DUELIST,   12, 13);
		assignItemRect(ARMOR_CLERIC,    10, 13);
	}
	...
	static{
		assignItemRect(ARTIFACT_CLOAK,      16,  15);
		assignItemRect(ARTIFACT_ARMBAND,    16, 15);
		assignItemRect(ARTIFACT_CAPE,       9, 11);
		assignItemRect(ARTIFACT_TALISMAN,   16, 13);
		assignItemRect(ARTIFACT_HOURGLASS,  14, 15);
		...
		assignItemRect(ARTIFACT_CHALICE1,   11, 14);
		assignItemRect(ARTIFACT_CHALICE2,   11, 14);
		assignItemRect(ARTIFACT_CHALICE3,   11, 14);
		assignItemRect(ARTIFACT_SANDALS,    10, 9 );
		assignItemRect(ARTIFACT_SHOES,      10, 9 );
		assignItemRect(ARTIFACT_BOOTS,      10, 14 );
		assignItemRect(ARTIFACT_GREAVES,    11, 16);
		assignItemRect(ARTIFACT_ROSE1,      14, 8);
		assignItemRect(ARTIFACT_ROSE2,      15, 13);
		assignItemRect(ARTIFACT_ROSE3,      15, 13);
		assignItemRect(ARTIFACT_TOME,       14, 15);
	}
	...
	static{
		assignItemRect(MEAT,            14, 11);
		assignItemRect(STEAK,           14, 11);
		assignItemRect(STEWED,          14, 14);
		assignItemRect(OVERPRICED,      14, 11);
		assignItemRect(CARPACCIO,       14, 11);
